...
begin
  ...
  if (credential.Username.Equals('bob')) and (credential.Password.Equals('1234')) then
    fAuthenticated := True
  else if (credential.Username.Equals('jeff')) and (credential.Password.Equals('1234')) then
    fAuthenticated := True
  else if (credential.Username.Equals('nick')) and (credential.Password.Equals('1234')) then
    fAuthenticated := True;
